...
with open('Q5_data.csv', newline='') as csvFile:
    data = csv.reader(csvFile, delimiter=',')
    for row in data:
            Critiques = dict((rows[0], (rows[1], rows[2], rows[3], rows[4], rows[5], rows[6], rows[7], rows[8], rows[9], rows[10], rows[11], rows[12], rows[13], rows[14], rows[15])) for rows in data)
...
Sam_have_not_listen = ['M_1', 'M_3', 'M_4', 'M_5', 'M_8', 'M_12', 'M_13', 'M_14']
